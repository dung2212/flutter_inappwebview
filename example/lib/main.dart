    ...
    child: ListView(
      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          onTap: () {
            // Modular.to.pushReplacementNamed(context, '/InAppBrowser');
          },
        ),
        ListTile(
          title: Text('ChromeSafariBrowser'),
          onTap: () {
            // Modular.to.pushReplacementNamed(context, '/ChromeSafariBrowser');
          },
        ),
        ListTile(
          title: Text('InAppWebView'),
          onTap: () {
            // Modular.to.pushReplacementNamed(context, '/');
          },
        ),
        ListTile(
          title: Text('HeadlessInAppWebView'),
          onTap: () {
            // Modular.to.pushReplacementNamed(context, '/HeadlessInAppWebView');
          },
        ),
      ],
    ),
